...
* Model specification and inference
  ...
  #+BEGIN_SRC ipython
    ...
    q_rate_bias = ed.models.NormalWithSoftplusScale(loc=tf.Variable(tf.random_normal([n, 1])), scale=tf.Variable(tf.ones([n, 1])))
  ...
  #+BEGIN_EXAMPLE
    ...
    0          1.778338        0.088868         -0.005528        0.040109
  #+END_EXAMPLE
  :END:
  ...
  #+BEGIN_EXAMPLE
    ...
    0     0.871253        0.298329        1.114019
    1     0.685687        0.287167        0.640863
    2     0.832976        0.159951        0.965856
    3     0.700838        0.201023        0.691661
    4     0.814616        0.286287        0.668536
    5     0.691467        0.338760        0.586068
    6     0.783659        0.189187        1.144669
    7     0.802240        0.148922        0.988516
    8     0.834025        0.235027        0.944307
    9     0.772049        0.249792        0.860103
    10    0.473087        0.138666        0.834449
    11    0.849796        0.286646        0.688878
    12    0.866909        0.148218        0.906789
    13    1.008157        0.168500        1.100925
    14    0.534548        0.147212        0.874713
    15    0.577289        0.141847        1.087143
    16    0.592843        0.174559        0.780635
    17    0.868248        0.250584        0.808446
    18    0.643367        0.177204        0.868894
    19    0.610603        0.151856        0.739383
    20    0.561710        0.272148        0.618180
  #+END_EXAMPLE
  :END:
  ...
  array([[ 1.11401916],
           ...
           [ 0.87371033],
           [ 0.74348116],
           [ 0.61817998]], dtype=float32)
  #+END_EXAMPLE
  :END:
  
* Model comparison

  Compare against a model without overdispersion:
  ...
  #+BEGIN_SRC ipython
    ...
    resid_var_scale = tf.exp(tf.Variable(tf.zeros([1])))
    var = tf.exp(-log_rate) + resid_var_scale
  ...
  #+BEGIN_SRC ipython :ipyfile figure/hurdle.org/post-pred-no-overdispersion.png
    post_pred = ed.get_session().run(
      ed.copy(log_cpm, inf.latent_vars),
      {
        onehot: data['onehot'][nonzero_cpm],
  ...
  #+RESULTS:
  :RESULTS:
  [[file:figure/hurdle.org/post-pred-no-overdispersion.png]]
  :END:
