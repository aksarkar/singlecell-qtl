...
* QTL overlap
  ...
  #+BEGIN_SRC ipython
    ...
    phenos = [sample_mean, log_mean, mean, log_phi, var, variance, sample_fano, fano]
    qtls = [sample_mean_qtls, log_mean_qtls, mean_qtls, log_phi_qtls, var_qtls, variance_qtls, sample_fano_qtls, fano_qtls]
  ...
  #+BEGIN_EXAMPLE
    ...
    Sample mean              100          100      100          72.4
    $\log(\mu)$              100          100      100          71.3
    ZI mean                  100          100      100          68.3
    $\log(\phi)$               0            0        0           100
    Sample variance          100          100      100            82
    ZI variance              100          100      100          80.4
    Sample Fano              100          100      100          84.6
    ZI Fano                  100          100      100          84.6

    Sample variance  ZI variance  Sample Fano  ZI Fano
    Sample mean                 99.2         98.4         88.2       89
    $\log(\mu)$                 99.1         99.1           87     89.8
    ZI mean                      100           99         89.1     90.1
    $\log(\phi)$                   0            0            0        0
    Sample variance              100          100          100      100
    ZI variance                  100          100           98      100
