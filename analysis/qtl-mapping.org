...
** Call Fano-QTLs
   ...
   #+BEGIN_SRC ipython
     covars = pd.DataFrame(skd.PCA(n_components=2).fit(fano).components_, columns=fano.columns)
     covars.index.name = 'id'
   ...
   #+CALL: qtltools(pheno="fano", geno="/scratch/midway2/aksarkar/singlecell/reproduce-yang/yri-dosages.vcf.gz", op="--cov sample-fano-covars.txt --window 100000 --permute 10000") :dir /scratch/midway2/aksarkar/singlecell/scqtl-mapping
